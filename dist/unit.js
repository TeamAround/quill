...
var container_1 = __webpack_require__(23);
var format_1 = __webpack_require__(25);
var leaf_1 = __webpack_require__(26);
var scroll_1 = __webpack_require__(64);
var inline_1 = __webpack_require__(65);
var block_1 = __webpack_require__(66);
var embed_1 = __webpack_require__(67);
var text_1 = __webpack_require__(68);
var attributor_1 = __webpack_require__(13);
var class_1 = __webpack_require__(40);
...
var Parchment = {
    ...
    getWindow: window_1.getWindow,
    setWindow: window_1.setWindow,
    getDocument: window_1.getDocument,
};
...
function create(input, value) {
    ...
    var BlotClass = match;
    var node = input instanceof Node ||
        // @ts-ignore
...
var Quill = function () {
  _createClass(Quill, null, [{
    ...
    key: 'setWindow',
    value: function setWindow(__window) {
      _window = __window;
      _parchment2.default.setWindow(_window);
    }
  }, {
    key: 'getWindow',
...
function expandConfig(container, userConfig) {
  ...
  ['bounds', 'container', 'scrollingContainer'].forEach(function (key) {
    if (typeof userConfig[key] === 'string') {
      userConfig[key] = container.ownerDocument.querySelector(userConfig[key]);
    }
  });
...
var _break = __webpack_require__(20);
  ...
  _createClass(Emitter, null, [{
    ...
    value: function initialize() {
      ...
      EVENTS.forEach(function (eventName) {
        _quill2.default.getDocument().addEventListener(eventName, function () {
          for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }

          [].slice.call(_quill2.default.getDocument().querySelectorAll('.ql-container')).forEach(function (node) {
            // TODO use WeakMap
...
var isDate = __webpack_require__(85);
...
var _clone = __webpack_require__(29);
...
var Selection = function () {
  function Selection(scroll, emitter) {
    ...
    this.handleDragging();
    this.emitter.listenDOM('selectionchange', _quill2.default.getDocument(), function () {
      if (!_this.mouseDown) {
  ...
  _createClass(Selection, [{
    ...
    value: function handleDragging() {
      ...
      this.emitter.listenDOM('mousedown', _quill2.default.getDocument().body, function () {
        _this3.mouseDown = true;
      });
      this.emitter.listenDOM('mouseup', _quill2.default.getDocument().body, function () {
...
function isTextNode(node) {
  return node instanceof Text || (typeof node === 'undefined' ? 'undefined' : _typeof(node)) === 'object' && 'ownerDocument' in node && node instanceof node.ownerDocument.defaultView.Text;
}
...
var _op = __webpack_require__(28);
...
var _code = __webpack_require__(12);
...
var _indent = __webpack_require__(92);
...
var _italic = __webpack_require__(96);
...
var _script = __webpack_require__(97);

var _script2 = _interopRequireDefault(_script);

var _strike = __webpack_require__(98);

var _strike2 = _interopRequireDefault(_strike);

var _underline = __webpack_require__(99);
...
var _formula = __webpack_require__(102);

var _formula2 = _interopRequireDefault(_formula);

var _syntax = __webpack_require__(103);
...
var _bubble = __webpack_require__(136);
...
Object.defineProperty(exports, "__esModule", { value: true });
var linked_list_1 = __webpack_require__(63);
...
var hasSymbolSham = __webpack_require__(77);
...
module.exports = {
  'align': {
    ...
    'center': __webpack_require__(105),
    'right': __webpack_require__(106),
    'justify': __webpack_require__(107)
  },
  'background': __webpack_require__(108),
  'blockquote': __webpack_require__(109),
  'bold': __webpack_require__(110),
  'clean': __webpack_require__(111),
  'code': __webpack_require__(56),
  'code-block': __webpack_require__(56),
  'color': __webpack_require__(112),
  'direction': {
    '': __webpack_require__(113),
    'rtl': __webpack_require__(114)
  },
  'float': {
    'center': __webpack_require__(115),
    'full': __webpack_require__(116),
    'left': __webpack_require__(117),
    'right': __webpack_require__(118)
  },
  'formula': __webpack_require__(119),
  'header': {
    '1': __webpack_require__(120),
    '2': __webpack_require__(121)
  },
  'italic': __webpack_require__(122),
  'image': __webpack_require__(123),
  'indent': {
    '+1': __webpack_require__(124),
    '-1': __webpack_require__(125)
  },
  'link': __webpack_require__(126),
  'list': {
    'ordered': __webpack_require__(127),
    'bullet': __webpack_require__(128),
    'check': __webpack_require__(129)
  },
  'script': {
    'sub': __webpack_require__(130),
    'super': __webpack_require__(131)
  },
  'strike': __webpack_require__(132),
  'underline': __webpack_require__(133),
  'video': __webpack_require__(134)
};
...
var Cursor = function (_Parchment$Embed) {
  ...
  function Cursor(domNode, selection) {
    ...
    _this.textNode = _quill2.default.getDocument().createTextNode(Cursor.CONTENTS);
    ...
    value: function restore() {
      ...
      if (this.textNode.data !== Cursor.CONTENTS) {
        ...
        if (this.next instanceof _text2.default) {
          ...
          this.textNode = _quill2.default.getDocument().createTextNode(Cursor.CONTENTS);
...
var _embed = __webpack_require__(49);
...
var BaseTheme = function (_Theme) {
  ...
  function BaseTheme(quill, options) {
    ...
    var listener = function listener(e) {
      if (!_quill2.default.getDocument().body.contains(quill.root)) {
        return _quill2.default.getDocument().body.removeEventListener('click', listener);
      }
      if (_this.tooltip != null && !_this.tooltip.root.contains(e.target) && _quill2.default.getDocument().activeElement !== _this.tooltip.textbox && !_this.quill.hasFocus()) {
        _this.tooltip.hide();
      }
    ...
    quill.emitter.listenDOM('click', _quill2.default.getDocument().body, listener);
    return _this;
  }
    ...
    toolbar: {
      handlers: {
        ...
        image: function image() {
          ...
          if (fileInput == null) {
            fileInput = _quill2.default.getDocument().createElement('input');
...
function fillSelect(select, values) {
  ...
  values.forEach(function (value) {
    var option = _quill2.default.getDocument().createElement('option');
...
var ShadowBlot = /** @class */ (function () {
    ...
    ShadowBlot.create = function (value) {
        ...
        var doc = window_1.getDocument() || document;
        var node;
...
var isArgs = __webpack_require__(43);

var origKeys = Object.keys;
var keysShim = origKeys ? function keys(o) { return origKeys(o); } : __webpack_require__(71);
...
var Embed = function (_Parchment$Embed) {
  ...
  function Embed(node) {
    ...
    _this.contentNode = _quill2.default.getDocument().createElement('span');
    _this.contentNode.setAttribute('contenteditable', false);
    [].slice.call(_this.domNode.childNodes).forEach(function (childNode) {
      _this.contentNode.appendChild(childNode);
    });
    _this.leftGuard = _quill2.default.getDocument().createTextNode(GUARD_TEXT);
    _this.rightGuard = _quill2.default.getDocument().createTextNode(GUARD_TEXT);
    ...
    value: function restore(node) {
      ...
      if (node === this.leftGuard) {
        if (this.prev instanceof _text2.default) {
          ...
          textNode = _quill2.default.getDocument().createTextNode(text);
...
var IconPicker = function (_Picker) {
  ...
  function IconPicker(select, icons) {
    ...
    _this.defaultItem = _this.container.querySelector('.ql-selected') || _this.container.querySelector('.ql-picker-item');
...
var Toolbar = function (_Module) {
  ...
  function Toolbar(quill, options) {
    ...
    if (Array.isArray(_this.options.container)) {
      var container = _quill2.default.getDocument().createElement('div');
      addControls(container, _this.options.container);
      quill.container.parentNode.insertBefore(container, quill.container);
      _this.container = container;
    } else if (typeof _this.options.container === 'string') {
      _this.container = _quill2.default.getDocument().querySelector(_this.options.container);
    } else {
      _this.container = _this.options.container;
    }
    if (!(_this.container instanceof HTMLElement) && !(_typeof(_this.container) === 'object' && 'ownerDocument' in _this.container && _this.container instanceof _this.container.ownerDocument.defaultView.HTMLElement)) {
      var _ret;
...
function addButton(container, format, value) {
  var input = _quill2.default.getDocument().createElement('button');
  input.setAttribute('type', 'button');
...
function addControls(container, groups) {
  ...
  groups.forEach(function (controls) {
    var group = _quill2.default.getDocument().createElement('span');
...
function addSelect(container, format, values) {
  var input = _quill2.default.getDocument().createElement('select');
  input.classList.add('ql-' + format);
  values.forEach(function (value) {
    var option = _quill2.default.getDocument().createElement('option');
    if (value !== false) {
...
var TextBlot = /** @class */ (function (_super) {
    ...
    TextBlot.create = function (value) {
        return window_1.getDocument().createTextNode(value);
    };
...
if (!Object.keys) {
	...
	var toStr = Object.prototype.toString;
	var isArgs = __webpack_require__(43); // eslint-disable-line global-require
...
var callBind = __webpack_require__(74);
...
var GetIntrinsic = __webpack_require__(76);
...
var bind = __webpack_require__(15);
var hasOwn = __webpack_require__(78);
...
var define = __webpack_require__(14);
var callBind = __webpack_require__(82);
...
var _extend2 = __webpack_require__(4);
...
var BubbleTooltip = function (_BaseTooltip) {
  ...
  function BubbleTooltip(quill, bounds) {
    ...
    _this2.quill.on(_emitter2.default.events.EDITOR_CHANGE, function (type, range, oldRange, source) {
      ...
      } else if (_quill2.default.getDocument().activeElement !== _this2.textbox && _this2.quill.hasFocus()) {
        _this2.hide();
      }
    });
    return _this2;
